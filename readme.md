...
生成式人工智能：上课讲的就是不同的生成式人工智能，结课是做一个主题的aigc，比较讨厌的点是他的组队是按照学号随机分配，所以很折磨，然后给分的时候呢，主要看的是一个组的表现，结课答辩会点你起来回答一下课程和你做的项目的相关问题（即使你答不上来但是只要你们组做的很完美那就是满绩，当然只要去了就不会挂科），如果组是随便ai的那大概就是七八十，反正会压力但是不会很为难。
